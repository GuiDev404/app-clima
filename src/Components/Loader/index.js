/*  
  Creator: https://codepen.io/tholman
  https://codepen.io/tholman/pen/yenku?editors=1100 
  Thanks ♥♥
*/
...
const Loader = () => {
  return (
    <div className="preloader" style={{ opacity: 1  }}>
      ...
      <div className="text text-uppercase">TRAYENDO LA INFORMACION... ESPERE UN SEGUNDO</div>
    </div>
  );
}
